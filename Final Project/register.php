...
<form action="register.php" method="POST">
      ...
      <p>Required fields are followed by *</p>
        ...
        <p>Email:* <input type="email" name="email" id="email" placeholder="Enter your email"  value="<?php echo $Email; ?>" required></p>
        <p>Phone:* <input type="number" name="phone" id="phone" placeholder="Enter your phone number" value="<?php echo $Phone; ?>" required></p>
