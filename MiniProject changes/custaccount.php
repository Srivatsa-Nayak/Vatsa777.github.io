      ...
      $query = mysqli_query($con,$selectquery);
       ...
       while($res = mysqli_fetch_array($query)){
        ...
        <tr>
            ...
            <td> <a href="" data-toggle="tooltip" title="Issue Bill!"><a style="color:#00ff00;" title="Issue bill" href="bill.php" target="_blank"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
        </tr>
        <?php
       }
       ?>
